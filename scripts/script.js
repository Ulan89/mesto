const popupProfileCloseButton = document.querySelector('.popup__close-button_section_edit');
...
const popupAddCardClose = document.querySelector('.popup__close-button_section_add')
